...
public class C206_CaseStudy {
	...
	public static void viewAllCurrency(ArrayList<Currency> currencyList) {
		...
		for (Currency i : currencyList) {
			...
			System.out.println(String.format("%-10s%-20s%-20s%-20s", items[0], items[1], items[OPTION_2], items[3]));
		}
	}

	public static void CURRENCY_HEADER() {
		Helper.line(20, "-");
...
//	}
	...
	/*
	 * Helper.line(20, "-"); System.out.println("VIEW ALL HOLDING"); Helper.line(20,
	 * "-"); for (MoneyHolding i : holdingList) { String items [] =
	 * i.toString().split(",");
	 * 
	 * //HOW TO CALCULATE THE SGD VALUE int sgd = Integer.parseInt(items[1]);
	 * //----> HOW GET THE SELL RATE
	 * System.out.println(String.format("%-10s%-10.2f%-20.4f", items[0],
	 * items[1],sgd ));
	 * 
	 * }
	 */
